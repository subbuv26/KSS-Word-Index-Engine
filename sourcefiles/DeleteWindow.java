...
// Implementation : Delete wizard Window                                    //
...
class DeleteWindow extends JFrame {
   ...
   /*------------------------------------------------------------------------
   Constructor of DeleteWindow
   ------------------------------------------------------------------------*/
   
   DeleteWindow(HomeWindow hw, KSSDictionary dictionary) {
      super();
   ...
   public void initialiseComponents() {
      ...
      label3.setText("to delete words");
      label4.setText("Enter Word : ");
      addComponent(panel2, textArea, 120, 65, 160, 20);
      addComponent(panel2, deleteButton, 80, 105, 100, 30);
      ...
      this.setTitle("Delete a word from Dictionary");
      
                           //adding action listenters
   ...
   private void validateAndDeleteItem(String str) {
      Item item = new Item();
      if(isString(str) == false || str.equals("")) {
         ...
         item.word = str;
         item.frequency = 1;
         item = dictionary.deleteItem(item);
         if(item != null) { 
            hw.textArea2.setText("The word \"" + str +
            "\" is deleted successfully\n");
            if(item.frequency == 0)
               hw.textArea2.append("The word completely deleted\n");
            else {
            ...
            hw.textArea2.setText("Sorry!!! Deletion failed\nThe word \"" + 
            str + "\" doesn't exist\n");
